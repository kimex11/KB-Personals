...
describe('useCalendarEvents', () => {
  ...
  it('includes expenses, card payments, and plan payments as calendar events', () => {
    ...
    const cards: CreditCardDue[] = [
      { id: 'card-1', cardName: 'Visa Platinum', last4: '4821', statementBalance: 542.5, minimumPayment: 45, dueDate: '2026-08-20', balanceAnchorAt: '2026-08-01T00:00:00.000Z', imageUrl: null, imageStoragePath: null },
    ];
