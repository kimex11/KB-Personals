...
describe('WeeklyBillsPanel', () => {
  ...
  it('calls onMarkPaid with the bill id when Mark as Paid is clicked', () => {
    const onMarkPaid = vi.fn();
    const bills: CalendarEvent[] = [{ id: '1', type: 'bill', title: 'Rent', date: '2026-08-15', amount: 1450 }];
    render(<WeeklyBillsPanel bills={bills} referenceDate={referenceDate} onMarkPaid={onMarkPaid} />);
